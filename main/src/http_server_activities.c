...
#define APPEND(fmt, ...) \
    ...
    APPEND("<!DOCTYPE html><html><head><meta charset='UTF-8'>"
           ...
           "<style>body{font-family:sans-serif;margin:1em;max-width:900px}"
           ...
           "padding:.6em .9em;margin:.6em 0;overflow-x:auto}"
...
#define APPEND(fmt, ...) \
    ...
    APPEND("<!DOCTYPE html><html><head><meta charset='UTF-8'>"
           ...
           "<style>body{font-family:sans-serif;margin:1em;max-width:800px}"
           "h2,h3{color:#333}table{border-collapse:collapse;width:100%%}"
           "th,td{border:1px solid #ccc;padding:4px 8px;text-align:left}"
