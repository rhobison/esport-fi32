 ...
 * without path or extension) to embedded binary data pointers and sizes.
 * The \c dyn_act_registry.c implementation is auto-generated by CMake at
 * configure time into \c ${CMAKE_CURRENT_BINARY_DIR}/generated/; it must
 * \b not be edited manually.
 *
...
typedef struct dyn_act_entry_tag
{
    ...
    const uint8_t * p_data; /**< Pointer to the first byte of the embedded HTML data. */
