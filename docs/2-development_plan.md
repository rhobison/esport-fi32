...
- [Phase 1 — NVS Configuration Manager](#phase-1--nvs-configuration-manager)
- [Phase 2 — WiFi Manager](#phase-2--wifi-manager)
- [Phase 3 — SNTP / Time Manager](#phase-3--sntp--time-manager)
- [Phase 4 — Pulse Input Module](#phase-4--pulse-input-module)
- [Phase 5 — Time Counter & Reward AP State Machine](#phase-5--time-counter--reward-ap-state-machine)
- [Phase 6 — Session Tracker](#phase-6--session-tracker)
- [Phase 7 — NVS Session Log](#phase-7--nvs-session-log)
- [Phase 8 — HTTP Server — Configuration & JSON API](#phase-8--http-server--configuration--json-api)
- [Phase 9 — HTTP Server — Status Dashboard](#phase-9--http-server--status-dashboard)
- [Phase 9A — HTTP Server Refactor: Shared Utilities](#phase-9a--http-server-refactor-shared-utilities)
- [Phase 9B — HTTP Server Refactor: Configuration Handlers](#phase-9b--http-server-refactor-configuration-handlers)
- [Phase 9C — HTTP Server Refactor: JSON API Handlers](#phase-9c--http-server-refactor-json-api-handlers)
- [Phase 9D — HTTP Server Refactor: Export Handlers](#phase-9d--http-server-refactor-export-handlers)
- [Phase 9E — HTTP Server Refactor: Status Dashboard](#phase-9e--http-server-refactor-status-dashboard)
- [Phase 9F — HTTP Server Refactor: Core Cleanup & Build Verification](#phase-9f--http-server-refactor-core-cleanup--build-verification)
- [Phase 10 — Integration & Verification](#phase-10--integration--verification)
- [Dependency Graph](#dependency-graph)
- [Module Prefix Table](#module-prefix-table)
- [Notes for AI Agents](#notes-for-ai-agents)
- [Improvement Features](#improvement-features)
  - [Quick Reference — Improvement Features](#quick-reference--improvement-features)
- [Feature 1 — Traffic-Gated Countdown Decrement](#feature-1--traffic-gated-countdown-decrement)
  - [Phase 1.1 — Spec Update](#phase-11--spec-update)
  - [Phase 1.2 — Config Manager](#phase-12--config-manager)
  - [Phase 1.3 — WiFi Manager: Throughput Query](#phase-13--wifi-manager-throughput-query)
  - [Phase 1.4 — Time Counter: Sliding-Window Gated Decrement](#phase-14--time-counter-sliding-window-gated-decrement)
  - [Phase 1.5 — Web UI & API: Pause Indicator and Config Fields](#phase-15--web-ui--api-pause-indicator-and-config-fields)
- [Feature 2 — Speed-Gated Pulse Increment](#feature-2--speed-gated-pulse-increment)
  - [Phase 2.1 — Spec Update](#phase-21--spec-update)
  - [Phase 2.2 — Pulse Input: Last Interval Query](#phase-22--pulse-input-last-interval-query)
  - [Phase 2.3 — Config Manager: Speed Threshold Parameter](#phase-23--config-manager-speed-threshold-parameter)
  - [Phase 2.4 — Time Counter: Speed-Gated Pulse Crediting](#phase-24--time-counter-speed-gated-pulse-crediting)
  - [Phase 2.5 — Web UI & API: Speed Threshold Config & Live Speed](#phase-25--web-ui--api-speed-threshold-config--live-speed)
- [Feature 3 — Reward Counter Persistence & Editability](#feature-3--reward-counter-persistence--editability)
  - [Phase 3.1 — Spec Update](#phase-31--spec-update)
  - [Phase 3.2 — Config Manager: Reward Counter Parameter](#phase-32--config-manager-reward-counter-parameter)
  - [Phase 3.3 — Time Counter: NVS Persistence & Counter Set](#phase-33--time-counter-nvs-persistence--counter-set)
  - [Phase 3.4 — Web UI: Reward Counter Config Field](#phase-34--web-ui-reward-counter-config-field)
- [Feature 4 — Per-Device Internet Access Control](#feature-4--per-device-internet-access-control)
  - [Phase 4.1 — Device Registry Module](#phase-41--device-registry-module)
  - [Phase 4.2 — WiFi Manager: Always-On Reward AP & MAC Filtering](#phase-42--wifi-manager-always-on-reward-ap--mac-filtering)
  - [Phase 4.3 — Time Counter: Per-Device Credit Earning & Tick Integration](#phase-43--time-counter-per-device-credit-earning--tick-integration)
  - [Phase 4.4 — HTTP Server: Config Page Device Management](#phase-44--http-server-config-page-device-management)
  - [Phase 4.5 — HTTP Server: API & Dashboard Per-Device Status](#phase-45--http-server-api--dashboard-per-device-status)
  - [Phase 4.6 — Spec Update: `docs/1-specification.md`](#phase-46--spec-update-docs1-specificationmd)
- [Feature 5 — Buzzer Feedback](#feature-5--buzzer-feedback)
  - [Phase 5.1 — Buzzer Core Module](#phase-51--buzzer-core-module)
  - [Phase 5.2 — Config Manager: Buzzer Enable Parameter](#phase-52--config-manager-buzzer-enable-parameter)
  - [Phase 5.3 — Session Tracker: Buzzer Integration](#phase-53--session-tracker-buzzer-integration)
  - [Phase 5.4 — Time Counter: Speed-Low Beep Integration](#phase-54--time-counter-speed-low-beep-integration)
  - [Phase 5.5 — HTTP Server: Buzzer Enable Config Field](#phase-55--http-server-buzzer-enable-config-field)
  - [Phase 5.6 — Spec Update: `docs/1-specification.md`](#phase-56--spec-update-docs1-specificationmd)
- [Feature 6 — Config Page Password Protection](#feature-6--config-page-password-protection)
  - [Phase 6.1 — Config Manager: Config Password Parameter](#phase-61--config-manager-config-password-parameter)
  - [Phase 6.2 — HTTP Config Auth: Basic Auth Guard](#phase-62--http-config-auth-basic-auth-guard)
  - [Phase 6.3 — HTTP Config Password Change Page](#phase-63--http-config-password-change-page)
  - [Phase 6.4 — Button Reset Module: BOOT Long-Press Reset](#phase-64--button-reset-module-boot-long-press-reset)
  - [Phase 6.5 — Integration & Build Verification](#phase-65--integration--build-verification)
  - [Phase 6.6 — Spec & Document Update](#phase-66--spec--document-update)
- [Feature 7 — Activity Credits](#feature-7--activity-credits)
  - [Phase 7.1 — Spec Update](#phase-71--spec-update)
  - [Phase 7.2 — Activity Manager Core Module](#phase-72--activity-manager-core-module)
  - [Phase 7.3 — HTTP Server: Activities Pages](#phase-73--http-server-activities-pages)
  - [Phase 7.4 — HTTP Server: Activity Credit API](#phase-74--http-server-activity-credit-api)
  - [Phase 7.5 — Integration & Verification](#phase-75--integration--verification)
  - [Phase 7.6 — Documentation & README Update](#phase-76--documentation--readme-update)
- [Feature 8 — Dynamic Activities (Mini-Games)](#feature-8--dynamic-activities-mini-games)
  - [Phase 8.1 — Data Model: `b_is_dynamic` Field and Credit Validation](#phase-81--data-model-b_is_dynamic-field-and-credit-validation)
  - [Phase 8.2 — Device Registry: MAC-Based PIN and Dual Auth Credit API](#phase-82--device-registry-mac-based-pin-and-dual-auth-credit-api)
  - [Phase 8.3 — Build Infrastructure and Demo Dynamic Activity Pages](#phase-83--build-infrastructure-and-demo-dynamic-activity-pages)
  - [Phase 8.4 — HTTP Server: User Dynamic Activities Page, File Server, and Manage UI](#phase-84--http-server-user-dynamic-activities-page-file-server-and-manage-ui)
  - [Phase 8.5 — Integration & Verification](#phase-85--integration--verification)
  - [Phase 8.6 — Documentation & README Update](#phase-86--documentation--readme-update)
  - [Phase 8.7 — Commit Message](#phase-87--commit-message)
- [Feature 9 — Gzip Compression of Embedded Dynamic Activity Files](#feature-9--gzip-compression-of-embedded-dynamic-activity-files)
  - [Phase 9.1 — CMake Build Infrastructure](#phase-91--cmake-build-infrastructure)
  - [Phase 9.2 — Registry Header Update](#phase-92--registry-header-update)
  - [Phase 9.3 — HTTP Handler Update](#phase-93--http-handler-update)
